...
import com.capg.beans.ConferenceRoomBean;
...
public class ConferenceStepDef {
	...
	private ConferenceRoomBean pageBean;
	@Before
	...
	public void user_is_on_Conference_room_booking_page() throws Throwable {
		...
		driver.get("file:///D:/Alekya_Selenium/LoginQ/Conf.html");
		driver.manage().window().maximize();
		pageBean= new ConferenceRoomBean();
